...
load D:\highimbalance\nursery\data_binary_5rand\train4.txt;
load D:\highimbalance\nursery\ntr.txt;
dim=size(train4,2)-2;
%dim=8;
sign0=[];
k0=1;
c=size(ntr,1);
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\basicdata_train4.txt','w');
...
%%////////////////////////////////////////////////////////////////////////////
        ...
        elseif ir<=99.00
           ...
           elseif numtr0(1)>0&numtr0(2)==0
              aver_index(1)=(1-sqrt(0.001*(1-pe)));
           elseif numtr0(1)==0&numtr0(2)>0
              aver_index(1)=(1-sqrt(0.001*(1-qe)));
           else
              aver_index(1)=0;
           end
        else
           ...
           elseif numtr0(1)>0&numtr0(2)==0
              aver_index(1)=(1/(1+alpha))*((pe+beta*0.001-2*beta*pe*0.001)/(2-pe-beta*0.001)+alpha*pe);
           elseif numtr0(1)==0&numtr0(2)>0
              aver_index(1)=(1/(1+alpha))*((0.001+beta*qe-2*beta*0.001*qe)/(2-0.001-beta*qe)+alpha*pe);
           else
              aver_index(1)=0;
           end
        end
...
%%////////////////////////////////////////////////////////////////////////////
        ...
        elseif ir<=99.00
           ...
           elseif numtr0(1)>0&numtr0(2)==0
              aver_index(2)=(1-sqrt(0.001*(1-pe)));
           elseif numtr0(1)==0&numtr0(2)>0
              aver_index(2)=(1-sqrt(0.001*(1-qe)));
           else
              aver_index(2)=0;
           end
        else
           ...
           elseif numtr0(1)>0&numtr0(2)==0
              aver_index(2)=(1/(1+alpha))*((pe+beta*0.001-2*beta*pe*0.001)/(2-pe-beta*0.001)+alpha*pe);
           elseif numtr0(1)==0&numtr0(2)>0
              aver_index(2)=(1/(1+alpha))*((0.001+beta*qe-2*beta*0.001*qe)/(2-0.001-beta*qe)+alpha*pe);
           else
              aver_index(2)=0;
           end
        end
...
%%////////////////////////////////////////////////////////////////////////////
        ...
        elseif ir<=99.00
           ...
           elseif numtr0(1)>0&numtr0(2)==0
              aver_index(3)=(1-sqrt(0.001*(1-pe)));
           elseif numtr0(1)==0&numtr0(2)>0
              aver_index(3)=(1-sqrt(0.001*(1-qe)));
           else
              aver_index(3)=0;
           end
        else
           ...
           elseif numtr0(1)>0&numtr0(2)==0
              aver_index(3)=(1/(1+alpha))*((pe+beta*0.001-2*beta*pe*0.001)/(2-pe-beta*0.001)+alpha*pe);
           elseif numtr0(1)==0&numtr0(2)>0
              aver_index(3)=(1/(1+alpha))*((0.001+beta*qe-2*beta*0.001*qe)/(2-0.001-beta*qe)+alpha*pe);
           else
              aver_index(3)=0;
           end
        end
...
%%////////////////////////////////////////////////////////////////////////////
        ...
        elseif ir<=99.00
           ...
           elseif numtr0(1)>0&numtr0(2)==0
              aver_index(4)=(1-sqrt(0.001*(1-pe)));
           elseif numtr0(1)==0&numtr0(2)>0
              aver_index(4)=(1-sqrt(0.001*(1-qe)));
           else
              aver_index(4)=0;
           end
        else
           ...
           elseif numtr0(1)>0&numtr0(2)==0
              aver_index(4)=(1/(1+alpha))*((pe+beta*0.001-2*beta*pe*0.001)/(2-pe-beta*0.001)+alpha*pe);
           elseif numtr0(1)==0&numtr0(2)>0
              aver_index(4)=(1/(1+alpha))*((0.001+beta*qe-2*beta*0.001*qe)/(2-0.001-beta*qe)+alpha*pe);
           else
              aver_index(4)=0;
           end
        end
...
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\w0.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w2');
fclose(fid);
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\theta0.txt','w');
    fprintf(fid,'%.8f\n',theta2');
fclose(fid);
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\w.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w4');
fclose(fid);
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\theta.txt','w');
    fprintf(fid,'%.8f\n',theta4');
fclose(fid);
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\w1.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w6');
fclose(fid);
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\theta1.txt','w');
    fprintf(fid,'%.8f\n',theta6');
fclose(fid);
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\w2.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w8');
fclose(fid);
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\theta2.txt','w');
    fprintf(fid,'%.8f\n',theta8');
fclose(fid);
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\sign0.txt','w');
    fprintf(fid,'%g\n',sign0');
fclose(fid);
...
load D:\highimbalance\nursery\data_binary_5rand\train4.txt;
load D:\highimbalance\nursery\ntr.txt;
load D:\highimbalance\nursery\inv_dcb1\result\w0.txt;
load D:\highimbalance\nursery\inv_dcb1\result\w.txt;
load D:\highimbalance\nursery\inv_dcb1\result\w1.txt;
load D:\highimbalance\nursery\inv_dcb1\result\w2.txt;
load D:\highimbalance\nursery\inv_dcb1\result\theta0.txt;
load D:\highimbalance\nursery\inv_dcb1\result\theta.txt;
load D:\highimbalance\nursery\inv_dcb1\result\theta1.txt;
load D:\highimbalance\nursery\inv_dcb1\result\theta2.txt;
load D:\highimbalance\nursery\inv_dcb1\result\sign0.txt;
...
err_train4
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\err_train4.txt','w');
...
% Total, average, geometric accuracy; AUC:
% For the test4 set.
load D:\highimbalance\nursery\data_binary_5rand\test4.txt;
load D:\highimbalance\nursery\nte.txt;
load D:\highimbalance\nursery\inv_dcb1\result\w0.txt;
load D:\highimbalance\nursery\inv_dcb1\result\w.txt;
load D:\highimbalance\nursery\inv_dcb1\result\w1.txt;
...
err_test4
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\err_test4.txt','w');
    fprintf(fid,'%g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g\n',err_test4');
fclose(fid);
...
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\Number_error_train4.txt','w');
    fprintf(fid,'\nFor the train4 set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
...
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\Number_error_test4.txt','w');
    fprintf(fid,'\nFor the test4 set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
