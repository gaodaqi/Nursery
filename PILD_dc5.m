...
load D:\highimbalance\nursery\data_binary_5rand\train5.txt;
load D:\highimbalance\nursery\ntr.txt;
dim=size(train5,2)-2;
%dim=8;
sign0=[];
k0=1;
c=size(ntr,1);
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\basicdata_train5.txt','w');
...
err_train5
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\err_train5.txt','w');
...
% Total, average, geometric accuracy; AUC:
% For the test5 set.
load D:\highimbalance\nursery\data_binary_5rand\test5.txt;
load D:\highimbalance\nursery\nte.txt;
load D:\highimbalance\nursery\inv_dcb1\result\w0.txt;
load D:\highimbalance\nursery\inv_dcb1\result\w.txt;
load D:\highimbalance\nursery\inv_dcb1\result\w1.txt;
...
err_test5
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\err_test5.txt','w');
    fprintf(fid,'%g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g\n',err_test5');
fclose(fid);
...
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\Number_error_train5.txt','w');
    fprintf(fid,'\nFor the train5 set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
...
fid=fopen('D:\highimbalance\nursery\inv_dcb1\result\Number_error_test5.txt','w');
    fprintf(fid,'\nFor the test5 set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
