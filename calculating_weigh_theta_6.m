...
%%////////////////////////////////////////////////////////////////////////////
        ...
        elseif ir<=99.00
           ...
           elseif numerror1>0&numerror2==0
              numerror(n,1)=(p0+q0)*(1-sqrt(0.001*(1-pe)));
           elseif numerror1==0&numerror2>0
              numerror(n,1)=(p0+q0)*(1-sqrt(0.001*(1-qe)));
           else
              numerror(n,1)=0;
           end
        else
           ...
           elseif numerror1>0&numerror2==0
              numerror(n,1)=(p0+q0)*((pe+beta*0.001-2*beta*pe*0.001)/(2-pe-beta*0.001)+alpha*pe)/(1+alpha);
           elseif numerror1==0&numerror2>0
              numerror(n,1)=(p0+q0)*((0.001+beta*qe-2*beta*0.001*qe)/(2-0.001-beta*qe)+alpha*pe)/(1+alpha);
           else
              numerror(n,1)=0;
           end
        end
...
%           numerror(n,1)=(p0+q0)*(1/(1+alpha))*((pe+beta*0.001-2*beta*pe*0.001)/(2-pe-beta*0.001)+alpha*pe);
%        elseif numtr0(1)==0&numtr0(2)>0
%           numerror(n,1)=(p0+q0)*(1/(1+alpha))*((0.001+beta*qe-2*beta*0.001*qe)/(2-0.001-beta*qe)+alpha*pe);
%        else
%           numerror(n,1)=0;
%        end
%%/////////////////////////////////////////////////////////////////////////////////////////////
